...
import au.priv.togglechat.toggles.custom.TypeCustom;
import au.priv.togglechat.toggles.defaults.friends.TypeFriendJoin;
import au.priv.togglechat.toggles.defaults.friends.TypeFriendLeave;
import au.priv.togglechat.toggles.defaults.friends.TypeFriendRequests;
import au.priv.togglechat.toggles.defaults.friends.TypeMessages;
import au.priv.togglechat.toggles.defaults.gamemode.TypeBuildBattle;
import au.priv.togglechat.toggles.defaults.gamemode.TypeHousing;
import au.priv.togglechat.toggles.defaults.gamemode.TypeMysteryBox;
import au.priv.togglechat.toggles.defaults.gamemode.TypePit;
import au.priv.togglechat.toggles.defaults.gamemode.TypeSkyBlockAbility;
import au.priv.togglechat.toggles.defaults.gamemode.TypeSkyBlockLevelUp;
import au.priv.togglechat.toggles.defaults.gamemode.TypeSoulWell;
import au.priv.togglechat.toggles.defaults.guilds.TypeGuild;
import au.priv.togglechat.toggles.defaults.guilds.TypeGuildJoin;
import au.priv.togglechat.toggles.defaults.guilds.TypeGuildLeave;
import au.priv.togglechat.toggles.defaults.otherchat.TypeColored;
import au.priv.togglechat.toggles.defaults.otherchat.TypeEasy;
import au.priv.togglechat.toggles.defaults.otherchat.TypeGlobal;
import au.priv.togglechat.toggles.defaults.otherchat.TypeShout;
import au.priv.togglechat.toggles.defaults.otherchat.TypeSpecial;
import au.priv.togglechat.toggles.defaults.otherchat.TypeSpectator;
import au.priv.togglechat.toggles.defaults.otherchat.TypeTeam;
import au.priv.togglechat.toggles.defaults.parties.TypeParty;
import au.priv.togglechat.toggles.defaults.parties.TypePartyInvites;
import au.priv.togglechat.toggles.defaults.qol.TypeAds;
import au.priv.togglechat.toggles.defaults.qol.TypeAutoQuest;
import au.priv.togglechat.toggles.defaults.qol.TypeGexp;
import au.priv.togglechat.toggles.defaults.qol.TypeLobbyJoin;
import au.priv.togglechat.toggles.defaults.qol.TypeMessageSeparator;
import au.priv.togglechat.toggles.defaults.qol.TypeTip;
import au.priv.togglechat.toggles.defaults.qol.TypeWatchdog;
import au.priv.togglechat.toggles.sorting.impl.ToggleBaseComparator;
